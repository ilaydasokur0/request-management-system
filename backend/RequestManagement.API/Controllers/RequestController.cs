...
public class RequestController : ControllerBase //.netin verdiği temel sınıf controllarbaseden kalıtım
{
    ...
    public IActionResult GetAllRequests() //tüm requestleri getiren metod
    {
        ...
        {
            new Request { Id = 1, Title = "Yazıcı arızası", Description = "3. kat yazıcı kağıt sıkıştırıyor, acil bakım gerekiyor.", Requester = "Ayşe Kaya", Assignee = "Mehmet Demir", Priority = Priority.High, CreatedAt = new DateTime(2026, 8, 20), Status = "Pending", Department = "IT" },
            ...
            new Request { Id = 6, Title = "Masraf iadesi", Description = "Şehir dışı toplantı için yol masrafı iade talebi.", Requester = "Can Öztürk", Assignee = "Zeynep Aydın", Priority = Priority.Low, CreatedAt = new DateTime(2026, 8, 10), AssignedAt = new DateTime(2026, 8, 11), Status = "InProgress", Department = "Finance" },
            ...
            new Request { Id = 10, Title = "Fatura itirazı", Description = "Tedarikçi faturasında tutar hatası var.", Requester = "Ayşe Kaya", Assignee = "Zeynep Aydın", Priority = Priority.High, CreatedAt = new DateTime(2026, 8, 12), AssignedAt = new DateTime(2026, 8, 13), Status = "InProgress", Department = "Finance" },
            new Request { Id = 11, Title = "Ofis malzemesi talebi", Description = "Kırtasiye malzemeleri tükendi.", Requester = "Ilayda Sokur", Assignee = "Mehmet Demir", Priority = Priority.Low, CreatedAt = new DateTime(2026, 7, 15), AssignedAt = new DateTime(2026, 7, 16), CompletedAt = new DateTime(2026, 7, 18), Status = "Completed", Department = "IT" },
            new Request { Id = 12, Title = "Uzaktan çalışma izni", Description = "1 haftalık uzaktan çalışma talebi.", Requester = "Can Öztürk", Assignee = "Zeynep Aydın", Priority = Priority.Medium, CreatedAt = new DateTime(2026, 8, 24), Status = "Pending", Department = "HR" }
        };
        return Ok(requests);
    }
}