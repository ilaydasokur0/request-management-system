    ...
    private static List<Request> _requests = new List<Request> //requestleri tutacak liste
        {
            ...
            new Request { Id = 5, Title = "VPN erişim talebi", Description = "Uzaktan çalışma için VPN hesabı açılması gerekiyor.", Requester = "Ilayda Sokur", Assignee = "", Priority = Priority.Medium, CreatedAt = new DateTime(2026, 8, 22), Status = "Pending", Department = "IT" },  
            ...
            new Request { Id = 7, Title = "Laptop arızası", Description = "Laptop açılışta mavi ekran veriyor.", Requester = "Ilayda Sokur", Assignee = "", Priority = Priority.High, CreatedAt = new DateTime(2026, 8, 23), Status = "Pending", Department = "IT" },
            ...
            new Request { Id = 11, Title = "Yeni yazıcı kurulumu", Description = "2. kat ofis için yeni yazıcı kurulumu talebi.", Requester = "Ayşe Kaya", Assignee = "", Priority = Priority.Medium, CreatedAt = new DateTime(2026, 8, 25), Status = "Pending", Department = "IT" },   
